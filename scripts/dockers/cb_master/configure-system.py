...
def configure(roles, machineguid, controller_addr, ssh):
    ...
    agentcontroller_client_service = j.application.getAppInstanceHRD(
        name="agentcontroller_client", instance="main"
    )
    osis_service = j.application.getAppInstanceHRD(name="osis", instance="main")
    osis_client_service = j.application.getAppInstanceHRD(
        name="osis_client", instance="main"
    )
    ...
    agentcontroller_client_service.set(
        "instance.agentcontroller.client.passwd", password
    )
    if controller_addr:
        agentcontroller_client_service.set(
            "instance.agentcontroller.client.addr", controller_addr
        )
